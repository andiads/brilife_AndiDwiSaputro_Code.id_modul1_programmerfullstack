...
CREATE TABLE `list_kontrasepsi` (
  `Id_Kontrasepsi` int(12) NOT NULL,
...
CREATE TABLE `list_pemakai_kontrasepsi` (
  ...
  `Id_Propinsi` int(12) DEFAULT NULL,
  `Id_Kontrasepsi` int(12) DEFAULT NULL,
  `Jumlah_Pemakai` int(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `list_kontrasepsi`
  MODIFY `Id_Kontrasepsi` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `list_pemakai_kontrasepsi`
--
ALTER TABLE `list_pemakai_kontrasepsi`
  MODIFY `Id_List` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `list_propinsi`
--
ALTER TABLE `list_propinsi`
  MODIFY `Id_Propinsi` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `list_pemakai_kontrasepsi`
  ADD CONSTRAINT `list_pemakai_kontrasepsi_ibfk_1` FOREIGN KEY (`Id_Propinsi`) REFERENCES `list_propinsi` (`Id_Propinsi`) ON DELETE NO ACTION,
  ADD CONSTRAINT `list_pemakai_kontrasepsi_ibfk_2` FOREIGN KEY (`Id_Kontrasepsi`) REFERENCES `list_kontrasepsi` (`Id_Kontrasepsi`) ON DELETE NO ACTION;
COMMIT;
